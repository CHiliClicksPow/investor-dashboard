...
export default function NewInvestorPage() {
  ...
  return (
    <div>
      <NavBar />
      <div style={{ maxWidth: 640, margin: '48px auto', fontFamily: "'DM Sans', system-ui, sans-serif", padding: 24 }}>
        <h1 style={{ fontSize: 26, marginBottom: 6, fontFamily: "'Sora', sans-serif", color: '#23223A' }}>Add Investor</h1>
        ...
        <form onSubmit={handleSubmit} style={{ background: '#fff', border: '1px solid #ECEBF5', borderRadius: 16, padding: 32, display: 'flex', flexDirection: 'column', gap: 18 }}>
          ...
          {success && <p style={{ color: '#1E8A4C', fontSize: 13 }}>Investor added — redirecting…</p>}
...
const inputStyle: React.CSSProperties = {
  width: '100%', border: '1px solid #E4E2F2', borderRadius: 10, padding: '12px 16px',
  fontSize: 14, boxSizing: 'border-box', fontFamily: "'DM Sans', sans-serif", color: '#23223A',
};

const buttonStyle: React.CSSProperties = {
  background: '#4F3FE0', color: '#fff', border: 'none', borderRadius: 10,
  padding: '14px', fontSize: 14, fontWeight: 700, cursor: 'pointer', fontFamily: "'Sora', sans-serif",
};
